...
#include "brepkit_c/ShapeSelector.h"
...
{
    auto shape = MakeBox();
    auto result = ShapeSelector::SelectFace(shape, ShapeSelector::FacePos::Z_MAX);
...
{
    auto shape = MakeBox();
    auto result = ShapeSelector::SelectFace(shape, ShapeSelector::FacePos::Z_MIN);
    REQUIRE(result != nullptr);
...
{
    auto shape = MakeBox();
    auto result = ShapeSelector::SelectFace(shape, ShapeSelector::FacePos::X_MAX);
    REQUIRE(result != nullptr);
...
{
    auto shape = MakeBox();
    auto result = ShapeSelector::SelectFace(shape, ShapeSelector::FacePos::Y_MAX);
    REQUIRE(result != nullptr);
...
TEST_CASE("SelectFace by index")
{
    ...
    auto result = ShapeSelector::SelectFace(shape, 1);
    REQUIRE(result != nullptr);

    // Out of range: 0 is below minimum
    auto result0 = ShapeSelector::SelectFace(shape, 0);
    REQUIRE(result0 == nullptr);

    // Out of range: 100 is way above extent
    auto result100 = ShapeSelector::SelectFace(shape, 100);
...
TEST_CASE("SelectFace by ray")
{
    ...
    auto result = ShapeSelector::SelectFace(shape, ray);
    REQUIRE(result != nullptr);
