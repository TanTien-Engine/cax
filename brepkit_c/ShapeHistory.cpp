...
class BuilderHist : public brepkit::ShapeHistory::History
{
public:
...
class ToolsHist : public brepkit::ShapeHistory::History
{
public:
...
class OffsetHist : public brepkit::ShapeHistory::History
{
public:
...
ShapeHistory::ShapeHistory(const TopoShape& new_shape)
{
    TopExp::MapShapes(new_shape.GetShape(), new_shape.GetShape().ShapeType(), m_new_map);
}

ShapeHistory::ShapeHistory(BRepBuilderAPI_MakeShape& builder, TopAbs_ShapeEnum type, 
...
ShapeHistory::ShapeHistory(opencascade::handle<BRepTools_History> hist, TopAbs_ShapeEnum type,
                         const TopoShape& new_shape, const TopoShape& old_shape)
{
...
ShapeHistory::ShapeHistory(const BRepOffset_MakeSimpleOffset& builder, const TopoShape& old_shape)
{
...
void ShapeHistory::BuildHistory(const std::shared_ptr<History>& hist, TopAbs_ShapeEnum type,
                               const TopoShape& new_shape, const TopoShape& old_shape)
{
