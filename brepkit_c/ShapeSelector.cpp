...
std::shared_ptr<TopoShape> ShapeSelector::SelectFace(const std::shared_ptr<TopoShape>& shape, FacePos pos)
{
...
std::shared_ptr<TopoShape> ShapeSelector::SelectFace(const std::shared_ptr<TopoShape>& shape, const sm::Ray& ray)
{
...
std::shared_ptr<TopoShape> ShapeSelector::SelectEdge(const std::shared_ptr<TopoShape>& shape, const sm::Ray& ray)
{
    gp_Pnt pos = trans_pnt(ray.origin);
    gp_Dir dir = trans_dir(ray.dir);
    gp_Lin line(pos, dir);
