                                            ...
                                            const std::shared_ptr<brepdb::VersionTree>& vt)
{
    ...
    try {
        ...
        shape = std::make_shared<brepkit::TopoShape>(mk_face.Face());
        if (tn && vt)
        {
                                          ...
                                          const std::shared_ptr<brepdb::VersionTree>& vt)
{
    ...
    try {
        ...
        shape = std::make_shared<brepkit::TopoShape>(mk_box.Shape());
        if (tn && vt)
        {
            brepdb::WorldSender sender(tn);
            brepdb::BRepWorld world;
                                               ...
                                               const std::shared_ptr<brepdb::VersionTree>& vt)
{
    ...
    try {
        ...
        shape = std::make_shared<brepkit::TopoShape>(mk_cyl.Shape());
        if (tn && vt)
        {
            brepdb::WorldSender sender(tn);
            brepdb::BRepWorld world;
                                           ...
                                           const std::shared_ptr<brepdb::VersionTree>& vt)
{
    ...
    try {
        ...
        shape = std::make_shared<brepkit::TopoShape>(mk_cone.Shape());
        if (tn && vt)
        {
            brepdb::WorldSender sender(tn);
            brepdb::BRepWorld world;
                                             ...
                                             const std::shared_ptr<brepdb::VersionTree>& vt)
{
    ...
    try {
        ...
        shape = std::make_shared<brepkit::TopoShape>(mk_sphere.Shape());
        if (tn && vt)
        {
            brepdb::WorldSender sender(tn);
            brepdb::BRepWorld world;
                                            ...
                                            const std::shared_ptr<brepdb::VersionTree>& vt)
{
    ...
    try {
        ...
        shape = std::make_shared<brepkit::TopoShape>(mk_torus.Shape());
        if (tn && vt)
        {
            brepdb::WorldSender sender(tn);
            brepdb::BRepWorld world;
                                                ...
                                                const std::shared_ptr<brepdb::VersionTree>& vt)
{
    ...
    auto shape = std::make_shared<brepkit::TopoShape>(aTool.Shape());
    if (tn && vt)
    {
        brepdb::WorldSender sender(tn);
        brepdb::BRepWorld world;
